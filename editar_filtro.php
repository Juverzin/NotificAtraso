...
<div class="card card-center">
  <div class="card-body">
    <h5 class="card-title mb-4 text-center">Buscar Atrasos por Matrícula</h5>
    <form action="listar_atrasos.php" method="GET">
      <div class="mb-3">
        <label for="matricula" class="form-label">Digite a matrícula do aluno:</label>
        <input type="text" name="matricula" id="matricula" class="form-control" required>
      </div>
      <div class="d-grid">
        <button type="submit" class="btn btn-yellow w-100">Buscar Atrasos</button>
      </div>
    </form>
  </div>
</div>
